...
| FEAT-MENTOR-CONSOLE | P2 | **Mentor console** — see & set controls for advisors/members below (Global/Group tiers) | Feature | Firm tier built (FEAT-FIRM-CONSOLE); higher tiers blocked by FEAT-RBAC (Q-ROLES) |
