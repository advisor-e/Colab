...
| FEAT-GROUP-JOIN-APPROVAL | P3 | Owner-side **approve/decline** of group-join requests (pending → member) | Feature | Blocked by manage-group / FEAT-RBAC (Q-ROLES) · see Done note |
