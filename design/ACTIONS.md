...
| FEAT-RBAC | P2 | Role hierarchy / RBAC enforcement (Mentor→Global→Group→Firm→Advisor→Client) | Feature | **Unblocked 2026-07-06** (Q-ROLES resolved) — ready to build on the hybrid seam · HANDOVER §6 |
